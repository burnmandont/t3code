...
import type { RelayManagedEndpointOrigin } from "@t3tools/contracts/relay";
...
// Keep the upstream module surface stable while production consumers depend on
// the provider-neutral service module directly.
export * from "./ManagedEndpointProviderService.ts";
