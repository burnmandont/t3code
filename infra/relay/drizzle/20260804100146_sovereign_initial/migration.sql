...
CREATE TABLE "relay_managed_endpoint_allocations" (
	"user_id" varchar(191),
	"environment_id" varchar(191),
	"provider_kind" varchar(32) DEFAULT 'cloudflare_tunnel' NOT NULL,
	"hostname" text NOT NULL,
	"tunnel_id" varchar(191),
	"tunnel_name" text NOT NULL,
	"dns_record_id" varchar(191),
	"connector_token_hash" varchar(191),
	"ready_at" varchar(64),
	"created_at" varchar(64) NOT NULL,
	"updated_at" varchar(64) NOT NULL,
...
CREATE UNIQUE INDEX "idx_relay_managed_endpoint_allocations_tunnel_name" ON "relay_managed_endpoint_allocations" ("tunnel_name");--> statement-breakpoint
CREATE UNIQUE INDEX "idx_relay_managed_endpoint_allocations_tunnel_id" ON "relay_managed_endpoint_allocations" ("tunnel_id");--> statement-breakpoint
