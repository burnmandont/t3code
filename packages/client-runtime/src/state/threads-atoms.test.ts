...
const makeHarness = Effect.fn("TestThreadAtoms.makeHarness")(function* (options?: {
  ...
  const environmentRegistry = EnvironmentRegistry.of({
    ...
    routes: yield* SubscriptionRef.make<
    ...
    selectRoute: () => Effect.die("Unexpected route selection"),
    connect: () => Effect.die("Unexpected environment connection"),
    disconnect: () => Effect.die("Unexpected environment disconnection"),
