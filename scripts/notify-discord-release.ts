  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Sovereign prerelease is available for nightly testers."
          : "A new Sovereign latest release is available.",
...
).pipe(Command.withDescription("Post a Sovereign release announcement to Discord."));
