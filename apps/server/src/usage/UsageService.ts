 ...
 *
 * The scan reads the provider CLIs' own session files rather than Sovereign's
 * orchestration projections, so usage covers turns driven outside Sovereign too.
