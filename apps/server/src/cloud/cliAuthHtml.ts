...
<html lang="en">
  <head>
    ...
    <title>Sovereign Relay authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up Sovereign Relay. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
