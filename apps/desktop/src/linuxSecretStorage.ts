...
function getGnomeKeyringRemediationMessage(): string {
  return "Sovereign could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Sovereign.";
}

function getKWalletRemediationMessage(): string {
  return "Sovereign could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Sovereign.";
}
