...
export const SOVEREIGN_AUTH_BEGIN_CHANNEL = "desktop:sovereign-auth-begin";
export const SOVEREIGN_AUTH_GET_SNAPSHOT_CHANNEL = "desktop:sovereign-auth-get-snapshot";
export const SOVEREIGN_AUTH_GET_TOKEN_CHANNEL = "desktop:sovereign-auth-get-token";
export const SOVEREIGN_AUTH_SIGN_OUT_CHANNEL = "desktop:sovereign-auth-sign-out";
export const SOVEREIGN_AUTH_STATE_CHANNEL = "desktop:sovereign-auth-state";
