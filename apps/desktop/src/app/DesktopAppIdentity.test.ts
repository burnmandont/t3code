...
const defaultEnvironmentInput = {
  ...
  processArch: "arm64",
  appVersion: "1.2.3",
  appPath: "/Applications/Sovereign.app/Contents/Resources/app.asar",
  isPackaged: true,
  resourcesPath: "/Applications/Sovereign.app/Contents/Resources",
  ...
  it.effect("configures app identity from the environment commit override", () => {
    ...
    return withIdentity(
      Effect.gen(function* () {
        ...
        assert.deepEqual(calls.setName, ["Sovereign (Alpha)"]);
        assert.equal(calls.setAboutPanelOptions[0]?.applicationName, "Sovereign (Alpha)");
