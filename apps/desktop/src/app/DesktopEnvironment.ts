...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  // Keep the pre-rebrand directory names so an in-place update adopts the
  // existing Electron state instead of silently creating a second profile.
