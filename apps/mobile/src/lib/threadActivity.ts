...
function isThreadFeedActivityUnchanged(
  ...
  return (
    ...
    previous.groupedToolDetail === next.groupedToolDetail &&
  ...
  switch (previous.type) {
    ...
    case "work-toggle": {
      ...
      return (
        ...
        previous.summary === nextToggle.summary &&
        previous.summaryKind === nextToggle.summaryKind &&
        previous.hasFailure === nextToggle.hasFailure &&
        previous.live === nextToggle.live &&
        previous.shimmer === nextToggle.shimmer
      );
    }
    case "turn-fold": {
