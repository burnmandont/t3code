...
interface CloudEnvironmentRowsProps {
  ...
  /**
   * Hide the "Sovereign Relay" section title + refresh button for hosts that
...
/**
 * "Sovereign Relay" section: every environment published to the signed-in account,
 * with connect switches, availability status, refresh, and loading/error
 * states. Shared between the Settings environments screen and the Sovereign Relay
 * onboarding sheet.
 *
