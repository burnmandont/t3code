...
// Keep the persisted t3-chat theme id for compatibility while presenting the
// fork's product name in the UI.
export const T3_CHAT_THEME_LABEL = "Sovereign";
...
// Older builds stored the dark Sovereign palette as a separate theme. Keep
...
/**
 * The palette Sovereign wears with no theme installed, captured from the app's
...
/**
 * The standard Sovereign look as a theme palette, for seeding a new theme when
 * no theme is installed. Distinct from {@link getDefaultThemeColors}, which
 * carries the flagship Sovereign palette used to fill roles omitted by theme
 * files.
 */
...
/**
 * The status colors Sovereign shows without a theme, read from the app's own
