...
/**
 * Post-sign-in onboarding wizard for Sovereign Relay. Opens on every in-session
 ...
 * account's Sovereign Relay environments so every device can be connected right
  ...
  return (
    ...
    >
      <DialogPopup className="max-w-xl">
        <DialogHeader>
          <DialogTitle>Set up Sovereign Relay</DialogTitle>
          <DialogDescription>
    ...
    <div className="space-y-3">
      <div className="rounded-lg border">
        <OnboardingToggleRow
          ...
          description="Make this environment available to your other devices through Sovereign Relay."
