...
during refactors. A 5,000-line sustained-output benchmark must remain part of
terminal hot-path validation. Record machine-specific before/after numbers in
the owning issue rather than treating one workstation's timings as a durable
product budget.
