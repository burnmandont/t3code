...
Connect a phone, browser, or another desktop app to Sovereign running on a different
machine. That machine must stay running and reachable while you work.

## Sovereign Relay

Sovereign Relay makes an environment available to your other devices without setting
up router forwarding. In the desktop app on the host, open **Settings →
Connections**, sign in, and enable **Sovereign Relay** for that environment.
...
On your other device, sign in to the same Sovereign account and choose the
...
**SSH**, and enter a host or SSH alias such as `user@example.com`. Sovereign starts
...
the connection stops a server that Sovereign launched; a server that was already
...
If an environment is available through both Sovereign Relay and SSH, use its
connection-method menu in **Settings → Connections** to choose the route for this
desktop. Sovereign prepares the candidate before switching; if preparation fails,
the current connection remains active. **Disconnect** is temporary. **Forget**
removes the saved environment and local credentials.

### Forward a remote TCP port

The desktop app can expose a service listening on the selected environment's
loopback interface as a loopback port on your computer. Open the environment in
**Settings → Connections**, add the remote host and port under **Port forwards**,
then choose **Start**. A forward follows the currently selected Relay or SSH route
and closes active streams when that route changes or the app exits.
...
To remove an environment from Sovereign Relay, open your account menu's **Sovereign Relay**
page, or **Settings → Sovereign Relay** on mobile, and choose **Deregister**. This
...
## Sovereign Relay troubleshooting
...
| Error                                                     | Recovery                                                                                                                                    |
| --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| `environment_link_limit_exceeded` or managed tunnel limit | Deregister an unused environment, then restart Sovereign on the host.                                                                       |
...
| Expired or invalid link proof                             | Check the host's date and time, update Sovereign, then restart it.                                                                          |
...
devices. For server version warnings, follow [Updating Sovereign](./updating.md).
