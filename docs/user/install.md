...
Sovereign is a web and desktop GUI for running coding agents on your machine.

## Requirements

Node.js `^22.16 || ^23.11 || >=24.10` on the machine that runs the Sovereign server.
...
This starts the Sovereign server on your machine and opens the local web app. Use
...
Sovereign drives provider CLIs; it does not ship them. Install the CLI for each provider you want
...
Sovereign looks for, but authenticate with `agent login`, not `cursor-agent login`.
...
Run the login command on the machine running the Sovereign server, not on the device you browse
from.
...
Sovereign. You can install Sovereign, open it, and add providers afterwards. A provider that is not
...
- [Permission modes](./permission-modes.md): how much Sovereign asks before acting
- [Remote access](./remote-access.md): connect from a phone, tablet, or another desktop
- [Keeping Sovereign in sync](./updating.md): client and server version skew
