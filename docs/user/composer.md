...
Messages can contain up to 120,000 characters. If a draft is longer, Sovereign keeps it in the
...
start it in the background. Sovereign opens another new thread and shows an **Open** action for the
