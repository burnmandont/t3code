...
- Reads the shared production Sovereign Relay URL and Clerk client configuration before packaging clients.
...
## Sovereign Relay relay deployment
...
10. Complete the Clerk Native API and AASA setup in [Sovereign Relay Clerk Setup](../internals/t3-connect.md#desktop-passkeys).
